...
export default function Adminpostevent() {
  ...
  "
          id="Event"
          placeholder="Enter The Event Descrption"
        />
      </div>
    </div>
...
"
        ...
        <div class="flex justify-center">
        <div class="mb-3 xl:w-96">
        <a href="#_" class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-emerald-500 rounded-full shadow-md group">
        ...
        <span class="absolute flex items-center justify-center w-full h-full text-blue-500 transition-all duration-300 transform group-hover:translate-x-full ease">Post Event</span>
        <span class="relative invisible">Post Event</span>
        </a>
        </div>
      </div>
      </div>
