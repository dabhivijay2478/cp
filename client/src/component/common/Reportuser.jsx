...
export default function Reportuser() {
  return (
    <>
 <div className="max-w-screen-xl mt-10 mb-10 px-8 grid gap-8 grid-cols-1  py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
 <div class="container mx-auto px-4 sm:px-8">
 <div class="py-8">
   <div>
     <h2 class="text-2xl font-semibold leading-tight">Report Student</h2>
   </div>
