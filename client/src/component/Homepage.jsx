        ...
        <div className="relative flex flex-col md:flex-row">
          ...
          >
            <span className="mx-auto text-xl font-black leading-none text-gray-900 select-none">
              Vijay<span className="text-indigo-600">.</span>
            </span>
          </a>
        ...
        <div className="flex flex-wrap items-center sm:-mx-3">
          <div className="w-full md:w-1/2 md:px-3">
            <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                <span className="block xl:inline">Vijay Dabhi </span>
          ...
          <div className="w-full md:w-1/2">
            <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
              <img src="https://user-images.githubusercontent.com/80666494/209432961-00bd3921-d913-4b27-9945-c187fda92d21.jpg" />
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
              <div className="flex items-center justify-center">
                <div className="w-16 h-16 mr-4 overflow-hidden bg-gray-200 rounded-full">
                  <img
                    src="https://user-images.githubusercontent.com/80666494/209432961-00bd3921-d913-4b27-9945-c187fda92d21.jpg"
                    className="object-cover w-full h-full"
                  />
                </div>
                <div className="flex flex-col items-start justify-center">
                  <h4 className="font-bold text-gray-800">Vijay Dabhi</h4>
    ...
    <section className="bg-white">
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p className="mt-8 text-base leading-6 text-center text-gray-400">
          © 2021 Vijay, Inc. All rights reserved.
        </p>
      </div>
    </section>
  </>
